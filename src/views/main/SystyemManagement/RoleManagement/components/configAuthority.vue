<template>
  <div class="custom-tree-container" :style="{ marginLeft: '35%', marginTop: '0px' }">
    <div class="block">
      <el-tree
        :data="data"
        show-checkbox
...
export default {
  ...
  methods: {
    handleCheckChange(data, checknodes) {
      ...
      console.log(node1, checknodes.checkedNodes, 6666666);
      this.roleData = checknodes.checkedNodes;
    //   let node2 = data;
    //   // console.log(node2);
