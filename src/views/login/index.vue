      ...
      <el-form-item class="el-flex" label="验证码">
        <template class="fl-j-center">
          <el-input
            ...
            @keyup.native="keyup"
          ></el-input>
          <a href="javascript:void(0);" title="点击更换验证码" class="codeImg" @click="getVerify">
...
export default {
  ...
  methods: {
    ...
    //获取验证码
    getVerify() {
      let src = `${process.env.BASE_API}/getVerifyCode?${new Date() *
        1}&sessionId=${this.sessionId}`;
      this.src = src;
    },
    //登录
    onLogin() {
    ...
    isEmpty() {
      ...
      if (!this.form.code.trim()) {
        ...
        this.form.text &&
        this.form.code.trim() != window.decodeURI(atob(this.form.text))
      ) {
    ...
    setCookie(c_name, c_pwd, exdays) {
      ...
      window.document.cookie =
        "EuserName" + "=" + c_name + ";path=/;expires=" + exdate.toGMTString();
      window.document.cookie =
        "Epassword" + "=" + c_pwd + ";path=/;expires=" + exdate.toGMTString();
